                                    ...
                                    <form action="" id="create_account">
                                        <div class="row form-group">
                                            <?php
                                                ...
                                                if(isset($_GET['id'])){
                                                    $stud = $conn->query("SELECT * From accounts where id = $id");
                                                }
                                            ?>
                                            <div class="col-md-4">
                                                <label for="" class="control-label">Last Name</label>
                                                <input type="text" class="form-control" name="lastname" <?php echo $lastname ?> required>
                                            </div>
                                            <div class="col-md-4">
                                                <label for="" class="control-label">First Name</label>
                                                <input type="text" class="form-control" name="firstname" <?php echo $firstname ?> required>
                                            </div>
                                            <div class="col-md-4">
                                                <label for="" class="control-label">Middle Name</label>
                                                <input type="text" class="form-control" name="middlename" <?php echo $middlename ?> >
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-md-4">
                                        ...
                                        <div class="row form-group">
                                            <div class="col-md-5">
                                                ...
                                                <textarea name="connected" id="" cols="30" rows="3" class="form-control"></textarea>
                                            </div>
                                            <div class="col-md-5">
